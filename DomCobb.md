...
| `Model - Claude.md` | When creating prompts for Anthropic Claude. Includes comprehensive production-ready practices: Extended Thinking, Structured Outputs, XML tags, prefill techniques, state management, Constitutional AI principles, and pre-publishing checklist. |
...
| `Technique - Multi-Agent Systems & Orchestration.md` | When designing or implementing multi-agent systems. Includes orchestration patterns (Sequential, Concurrent, Hierarchical, Group Chat, Handoff), communication protocols (ACP, MCP, A2A), task distribution strategies, error handling, coordination frameworks (AutoGen, CrewAI, LangGraph), production deployment patterns, best practices, and practical implementation guides. |
...
* **Multi-agent systems/orchestration** → `Technique - Multi-Agent Systems & Orchestration.md`
